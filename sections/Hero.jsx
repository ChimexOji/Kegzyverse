...
const Hero = () => (
  <section className={`${styles.yPaddings} sm:pl-16 pl-6`}>
    <motion.div
      ...
      initial="hidden"
      whileInView="show"
      viewport={{ once: false, amount: 0.25 }} //pops up multiple times when scrolling
    ...
    >
      ...
      <motion.div variants={slideIn('right', 'tween', 0.2, 1)} className="relative w-full md:-mt-[20px]
        -mt-[12px]"
      >
        {/* gradient div */}
        <div className="absolute w-full h-[300px] hero-gradient rounded-tl-[140px] z-[0] -top-[30px]" />
          ...
          >
            <img 
              src="/stamp.png" 
              alt="stamp" 
              className="sm:w-[155px] w-[100pz] 
              sm:h-[155px] h-[155px] object-contain"
            />
          </div>
          </a>
      </motion.div>
